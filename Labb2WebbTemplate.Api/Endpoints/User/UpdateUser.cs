...
public class UpdateUser(UnitOfWork unit)   
    : Endpoint<UserRequest, EmptyResponse>
{
    ...
    public override async Task HandleAsync(UserRequest req, CancellationToken ct)
    {
        ...
        if (city is null)
        {
            AddError(ErrorMessages.NotFound("cityId", req.Address.CityId));
        ...
        var repositoryStatus = await unit.Users.UpdateAsync(req.Id, userEntity);
